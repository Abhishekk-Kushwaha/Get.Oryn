        ...
        <div className="max-w-md md:max-w-xl mx-auto px-6 w-full relative z-10">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              transition={{ delay: 0.1 }}
              className="bg-orange-500/[0.04] border border-orange-500/20 rounded-2xl p-5 text-slate-900 relative flex flex-col justify-between scale-[1.03] active:scale-100 transition-all"
