            ...
            <div className="max-w-5xl mx-auto px-6 h-12 flex items-center justify-between">
              ...
              <div className="flex items-center gap-6 sm:gap-8">
                <button
                  ...
                  className={`text-sm font-semibold tracking-wide transition-colors cursor-pointer focus:outline-none ${activeSection === "features" ? "text-slate-900 font-extrabold" : "text-slate-500 hover:text-slate-900"
                    }`}
                >
                  Features
                </button>
                <button
                  ...
                  className={`text-sm font-semibold tracking-wide transition-colors cursor-pointer focus:outline-none ${activeSection === "pricing" ? "text-slate-900 font-extrabold" : "text-slate-500 hover:text-slate-900"
                    }`}
                >
                  Pricing
                </button>
        ...
        >
          ...
          <div className="bg-white text-slate-900 py-24 md:py-32 text-center relative overflow-hidden border-t border-slate-200">
            ...
            <div className="max-w-3xl mx-auto px-6 relative z-10">
              ...
              <p className="text-slate-500 text-lg md:text-xl mb-10 max-w-xl mx-auto">
          ...
          <footer className="bg-slate-50 py-10 px-8 border-t border-slate-200 pb-24 md:pb-10">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-slate-500">
              ...
              <div className="flex items-center gap-6">
                <span className="hover:text-slate-900 font-medium transition-colors cursor-pointer">Twitter</span>
